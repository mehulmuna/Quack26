...
const dashboardData = {
	stats: [
		{ label: 'Total Experiments', value: '128', trend: '+18% this week' },
		{ label: 'Services Monitored', value: '12', trend: '3 critical paths' },
		{ label: 'Active Attack', value: 'Packet Loss', trend: 'Running on auth stack' },
		{ label: 'Failures Found', value: '37', trend: '11 newly detected' },
	],
	services: [
		{
			name: 'Auth Service',
