...
5. After each docker_stop_instance, call memory_record_intervention with type container_stop and the container name.
...
Run a step-by-step chaos engineering test against the weaknesses above. Use toxiproxy_add_latency, docker_stop_instance, and toxiproxy_add_reset_peer one experiment at a time, record each intervention with memory_record_intervention, and finish with a concise attack report.`;
}
